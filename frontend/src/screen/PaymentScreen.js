...
const PaymentScreen = () => {
  ...
  return (
    ...
    <Form onSubmit={submitHandler}>
        ...
        <Row>
            <Col>
                <Form.Check type='radio' label='Papal or credit card' id='PayPal' name = 'paymentMethod' value='PayPal' checked onChange={(e) => setPaymentMethod(e.target.value)}></Form.Check>
